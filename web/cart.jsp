						...
						<tr>
							<td><img src="ad/page_ad.jpg" width="666" height="89" />
								<table width="100%" border="0" cellspacing="0">
                                    ...
                                    <table width="100%" border="0" cellspacing="0">
                                        <c:set var="totallPrice" value="0"></c:set>

                                        <c:forEach items="${cart}" var="entry" varStatus="v">
                                            <tr>
                                        ...
                                        <c:set var="totallPrice" value="${totallPrice + entry.key.price * entry.value}"></c:set>
											...
											<table cellspacing="1" class="carttable">
												<tr>
													<td style="text-align:right; padding-right:40px;"><font
														style="color:#FF6600; font-weight:bold">合计：&nbsp;&nbsp;${totallPrice}元</font>
													</td>
												</tr>
											</table>
											<div style="text-align:right; margin-top:10px">
												<a
													href="${pageContext.request.contextPath}/showProductsByPageServlet"><img
