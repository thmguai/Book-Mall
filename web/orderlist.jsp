				...
				<td width="25%"><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="${pageContext.request.contextPath}/findUserInfoServlet?id=${user.id}">用户信息修改</a>
							</td>
						</tr>
								...
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									...
									<c:forEach items="${orders}" var="order">
										<tr>
											...
											<td class="tableopentd02">${order.receiveName}</td>
											<td class="tableopentd02"><fmt:formatDate value="${order.orderTime}" pattern="YYYY-MM-dd HH:mm:ss"></fmt:formatDate> </td>
